...
const UserFollowing = () => {
    ...
    if(alluserdata && userProfileDetails.following !== undefined){
      alldata = alldata.filter(
       (items) =>  userProfileDetails.following.includes(items.username)
      )
...
<div className='followers_main'>
      ...
      <div className="follwers_header">
        ...
        <h3   onClick={()=>navigate("/userfollowers", {state:{data: profile_username }})}  >Followers</h3>
        <h3 style={{color:"black", fontWeight:"600", borderBottom:"2px solid rgb(221, 6, 78)"}}>Following</h3>
      </div>
      {
