  ...
  return (
    <>
     <div className="regi_main">
        <div className="loginbg" onClick={()=>{navigate("/")}}></div>
    <div className="regi">

    <div className="regi_name" style={{marginBottom:"30px"}}><h1>Login</h1></div>
    <form className='regi_form' method='POST'>
        ...
        <button className='regi_button_main'  onClick={()=>{navigate("/register")}}> Not Registered? Register</button>
